...
import 'package:simple_flutter/models/repository/r_product.dart';
...
import 'package:simple_flutter/screens/s_product_list.dart';
...
import 'package:simple_flutter/widgets/product_flow.dart';

/// StatelessWidget : state 가 변동되지 않는 화면
class MyApp extends StatelessWidget {
  final void Function(String routeName, Widget page, {required String title})
  onNavigate;
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: () {
              onNavigate(
                'valueNotifier',
                const TodoListWithValueNotifier(),
                title: "valueNotifier",
              );
            },
              ...
              children: [
                ...
                OutlinedButton(
                  onPressed: () {
                    ...
                    onNavigate(
                      'changeNotifier',
                      ChangeNotifierProvider<ChangeCounter>(
